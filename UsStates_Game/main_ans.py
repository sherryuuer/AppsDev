...
data = pandas.read_csv("UsStates_Game/50_states.csv")
...
while len(guessed_states) < 50:
    ...
    if answer_state == "Exit":
        ...
        new_data.to_csv("UsStates_Game/missing_states_list.csv")
        break
...
# data_to_save.to_csv("UsStates_Game/missing_states.csv")
